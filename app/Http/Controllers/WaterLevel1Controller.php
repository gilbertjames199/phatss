...
class WaterLevel1Controller extends Controller
{
    protected $w1;
    //
    public function __construct(WaterLevel1 $w1)
    {
        $this->w1 = $w1;
    }
    public function index(Request $request)
    {
        ...
        DB::flushQueryLog();
        $data = WaterLevel1::where('longitude', '<>', '')
            ->where('latitude', '<>', '')
        ...
        // dd(count($data));
        return inertia('WaterResource/Level1/Index', [
            "p_data" => $data,
            // "g0" => $dataG0,
            // "g1" => $dataG1,
            // "g2" => $dataG2,
